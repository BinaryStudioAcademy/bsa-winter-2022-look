...
const SettingsPhotosPage = () => import('./pages/SettingsPhotosPage.vue').then(m => m.default);
const SettingsChangePasswordPage = () => import('./pages/SettingsChangePasswordPage.vue').then(m => m.default);
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              name: 'main-settings-photos',
            },
            {
              component: SettingsChangePasswordPage,
              path: '/settings/change_password',
              name: 'main-settings-change-password',
            },
          ],
        },
      ],
